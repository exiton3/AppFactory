...
public class HttpResponseDataBuilder
{
    ...
    public HttpResponseDataBuilder StatusCode(int statusCode)
    {
        _response.StatusCode = (SystemHttpStatusCode)statusCode;
        return this;
    }

    public HttpResponseDataBuilder Header(string key, string value)
    {
    ...
    public HttpResponseDataBuilder Headers(IDictionary<string, string> headers)
    {
    ...
    public HttpResponseDataBuilder Body(string body)
    {
        _body = body;
        return this;
    }

    public HttpResponseDataBuilder Body<T>(T data)
    {
        _body = _jsonSerializer.Serialize(data);
        return this;
    }

    public HttpResponseDataBuilder ContentType(string contentType)
    {
        Header("Content-Type", contentType);
        return this;
    }

    public HttpResponseDataBuilder ErrorType(string errorType)
    {
        Header("x-error-type", errorType);
        return this;
    }

    public HttpResponseDataBuilder ProblemTitle(string title)
    {
        _problemTitle = title;
        return this;
    }

    public HttpResponseDataBuilder Errors(IEnumerable<Error> errors)
    {
        _errors = errors;
        return this;
    }
