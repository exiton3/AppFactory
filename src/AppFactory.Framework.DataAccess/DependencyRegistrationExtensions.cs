...
/// <summary>
/// Extension methods for registering DynamoDB persistence components in the dependency injection container
/// </summary>
public static class DependencyRegistrationExtensions
{
    /// <summary>
    /// Registers the DynamoDB infrastructure including client factory and settings
    /// </summary>
    ...
    /// <returns>The service collection for chaining</returns>
    public static IServiceCollection RegisterDynamoDbDataAccess(this IServiceCollection services, params Assembly[] assemblies)
    {
        var assembliesToScan = assemblies.Length > 0 
            ? assemblies 
            : new[] { Assembly.GetCallingAssembly() };
