...
public static class QueueStorageRegistrationExtensions
{
    /// <summary>
        ...
        Action<AzureQueueStorageOptions> configureOptions)
    {
        ...
        {
            var options = ServiceProviderServiceExtensions.GetRequiredService<Microsoft.Extensions.Options.IOptions<AzureQueueStorageOptions>>(provider).Value;
